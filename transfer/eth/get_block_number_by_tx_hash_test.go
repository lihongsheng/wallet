...
func TestGetBlockNumberByTxHash(t *testing.T) {
	...
	client, err := ethclient.Dial("https://etc.rivet.link")
	if err != nil {
	...
	// 替换为实际的交易哈希
	txHash := common.HexToHash("0x2ac0938e952c875ab83a2ad3712b11e8973ed5faefc17488daec5f384bd31038")
	// 通过交易哈希获取交易收据
...
func TestGetLatestBlock(t *testing.T) {
	...
	block, err := client.BlockByNumber(context.Background(), blockInt)
	if err != nil {
